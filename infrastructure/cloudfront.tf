    ...
    origin{
        ...
        default_cache_behavior{
            ...
            dynamic "custom_error_response"{
                ...
                error_code = custom_error_response.value.error_caching_min_ttl
                response_code = custom_error_response.value.error_caching_min_ttl
                response_page_path = custom_error_response.value.error_caching_min_ttl
            }
        }
